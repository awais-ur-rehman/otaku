                      ...
                      child: Column(
                        ...
                        children: [
                          SizedBox(
                            ...
                            width: screenWidth,
                            child: const Image(image: AssetImage('assets/images/signin.png'),
                              fit: BoxFit.contain,
                            ),
                          ),
                          Text(
                          ...
                          CustomFlatButton(
                            onTap: () async {
                              final navigatorContext = GoRouter.of(context).routerDelegate.navigatorKey.currentContext;
                              bool success = await context.read<SigninCubit>().loginUser();
                              print(success);
                              if (success) {
                                if(context.mounted){
